...
Prefer a single imperative-style subject line consistent with the repository. Add a blank line and a concise bulleted body only when the change needs details beyond a clear subject. The draft must describe only the observed changes; do not invent behavior or include tool chatter.
